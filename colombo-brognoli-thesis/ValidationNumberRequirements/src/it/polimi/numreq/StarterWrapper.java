...
mapReward.put("CkMax",6.0f);AlternativeUtility.start(rewardNameList);
}
public void doActivity(){
		try {Thread.sleep(50);} catch (InterruptedException e) {e.printStackTrace();}AlternativeUtility.updateContext(rewardNameList, "A", mapReward);}}