...
public class PhoneStateSample extends Activity {
	...
	private int getDataDirectionRes(int direction){
		...
		switch(direction)
		{
			case TelephonyManager.DATA_ACTIVITY_IN: 	resid = R.drawable.data_in; break;
			case TelephonyManager.DATA_ACTIVITY_OUT: 	resid = R.drawable.data_out; break;
			case TelephonyManager.DATA_ACTIVITY_INOUT: 	resid = R.drawable.data_both; break;
			case TelephonyManager.DATA_ACTIVITY_NONE: 	resid = R.drawable.data_none; break;
    ...
    private final PhoneStateListener phoneStateListener = new PhoneStateListener(){
		...
		{
			Log.i(APP_NAME, "onSignalStrengthsChanged " + signalStrength.getGsmSignalStrength());
			
			setSignalLevel(info_ids[INFO_SIGNAL_LEVEL_INDEX],info_ids[INFO_SIGNAL_LEVEL_INFO_INDEX], signalStrength.getGsmSignalStrength());
			
			super.onSignalStrengthChanged(signalStrength.getGsmSignalStrength());
		}
    };
}